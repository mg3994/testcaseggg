...
This extension shows reference search results as separate view, just like search results. It complements the peek view presentation that is also built into Code OSS. The following feature are available:
...
**Note** that this extension is bundled with Code OSS version 1.29 and later - it doesn't need to be installed anymore.
...
This extension ships with Code OSS and uses its issue tracker. Please file issue here: https://github.com/Microsoft/vscode/issues

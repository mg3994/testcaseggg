  ...
  {pkgs}:
  let
    flutterProjectDir = "/home/user/testcaseggg/testcaseggg_flutter"; # Define your Flutter project directory here
    serverProjectDir = "/home/user/testcaseggg/testcaseggg_server"; # Define your Laravel project directory here
    clientProjectDir = "/home/user/testcaseggg/testcaseggg_client"; # Define your Client project directory here
  in 
  {
      ...
      previews = {
        ...
        previews = {
          ...
          API_SERVICE = "https://$PORT-$WEB_HOST";
            ...
            command = ["flutter" "run" "--machine" "-d" "web-server" "--web-hostname" "0.0.0.0" "--web-port" "$PORT" "--dart-define=WEB_HOST=$WEB_HOST" "--web-browser-flag" "--disable-web-security"];
            manager = "flutter";
          };
          # android = {
          #   cwd = "${flutterProjectDir}";
